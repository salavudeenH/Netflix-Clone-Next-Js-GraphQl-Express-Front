    ...
    <div className={styles.container}>
      ...
      <main>
       ...
       <div className="text-center mt-24">
        ...
        <button type="submit" className="start__button flex justify-center items-center"> Commencer <span className=""><svg width="20" height="20" viewBox="0 0 6 12" xmlns="http://www.w3.org/2000/svg"><desc>chevron</desc><path d="M.61 1.312l.78-.624L5.64 6l-4.25 5.312-.78-.624L4.36 6z" fill="white" fill-rule="evenodd"></path></svg></span>
        </button>
        </div>
